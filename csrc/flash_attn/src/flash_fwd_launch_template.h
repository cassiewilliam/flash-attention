...
void run_mha_fwd_splitkv_dispatch(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    KV_DTYPE_SWITCH(params.kvcache_dtype, T, [&]{
        constexpr static int kBlockN = Headdim <= 64 ? 256 : (Headdim <= 128 ? 128 : 64);
        run_flash_splitkv_fwd<Flash_fwd_kernel_traits<Headdim, kBlockM, kBlockN, 4, false, false, T, KV_T>, Is_causal>(params, stream);
    });
}
...
void run_mha_fwd_hdim32(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    DROPOUT_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
        KV_DTYPE_SWITCH(params.kvcache_dtype, T, [&]{
            run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 128, 4, false, false, T, KV_T>, Is_dropout, Is_causal>(params, stream);
        });
    });
}
    ...
    DROPOUT_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
        KV_DTYPE_SWITCH(params.kvcache_dtype, T, [&]{
            if constexpr(!Is_dropout) {
                ...
                run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, false, false, T, KV_T>, Is_dropout, Is_causal>(params, stream);
                // run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, true, true, T>, Is_dropout, Is_causal>(params, stream);
                // run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, true, false, T>, Is_dropout, Is_causal>(params, stream);
        ...
        KV_DTYPE_SWITCH(params.kvcache_dtype, T, [&]{
            ...
            if (is_sm8x) {
                if constexpr(!Is_causal) {
                    ...
                    run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 64, 64, 4, false, false, T, KV_T>, Is_dropout, Is_causal>(params, stream);
                }
            } else {
                run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, false, false, T, KV_T>, Is_dropout, Is_causal>(params, stream);
            }
    ...
    DROPOUT_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
        KV_DTYPE_SWITCH(params.kvcache_dtype, T, [&]{
            if constexpr(!Is_dropout) {
                ...
                if (is_sm8x) {
                    if constexpr(!Is_causal) {
                        run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 32, 4, false, false, T, KV_T>, Is_dropout, Is_causal>(params, stream);
                    } else {
                        run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 64, 64, 4, false, false, T, KV_T>, Is_dropout, Is_causal>(params, stream);
                    }
                } else {
...
void run_mha_fwd_hdim160(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    DROPOUT_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
        KV_DTYPE_SWITCH(params.kvcache_dtype, T, [&]{
            ...
            if (is_sm8x) {
                if constexpr(!Is_causal) {
                    run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 8, false, false, T, KV_T>, Is_dropout, Is_causal>(params, stream);
                } else {
                    run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 64, 64, 4, false, false, T, KV_T>, Is_dropout, Is_causal>(params, stream);
                }
            } else {
